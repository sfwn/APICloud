	        ...
	        try {  
	            ...
	            {  
	                ...
	                {  
	                    ...
	                    System.out.println("获取文件名："+value);
	                    //索引到最后一个反斜杠  
	                    ...
	                    fs.setUseName(UN);
	            		fs.setFileName(fName[0]);
	            		fs.setContentType(fName[1]);
	                   //----------------封装FileSource-----------------------------
	            		
	            		System.out.println("图片地址"+path+"\\"+filename);
	                    request.setAttribute(name, path+"\\"+filename);  
	                  ...
	                  //--------------封装FileSource-----------------------------  
	                    //-----------连接webservice 服务---------------
	                   Object returnvalue = FileUtil.upload(fs);
	                   request.setAttribute("return", returnvalue); 
	                    //-----------连接webservice 服务---------------     
	                } 
	            }  
